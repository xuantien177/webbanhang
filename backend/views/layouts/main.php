        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/" class="site_title"><i class="fa fa-paw"></i> <span>Xin Chào Tiến!</span></a>
                </div>
                        ...
                        \yiister\gentelella\widgets\Menu::widget(
                            [
                                "items" => [
                                    ...
                                    ["label" => "Blog", "url" => ["blog/index"], "icon" => "newspaper-o"],
                                    [
                                        "label" => "Danh mục",
                                        "icon" => "th",
                                        "url" => "#",
                                        "items" => [
                                            ["label" => "Phân loại sản phẩm", "url" => ["phan-loai/index"]],
                                            ["label" => "menu", "url" => ["site/panel"]],
                                            ["label" => "Slider", "url" => ["slider/index"]],
                                            ["label" => "Thương Hiệu", "url" => ["thuong-hieu/index"]],
                                            ["label" => "Từ khóa", "url" => ["tu-khoa/index"]],
