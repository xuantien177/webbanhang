...
<div class="don-hang-form">
    ...
    <?= $form->field($model, 'tinh_trang')->dropDownList([ 'Đang chờ xử lý' => 'Đang chờ xử lý', 'Đang xử lý' => 'Đang xử lý', 'Đang giao hàng' => 'Đang giao hàng','Đã giao hàng'=>'Đã giao hàng','Chờ xác nhận hủy'=>'Chờ xác nhận hủy', 'Hủy' => 'Hủy'], ['prompt' => '']) ?>
