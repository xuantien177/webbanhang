...
/**
 *
 * @var \common\models\DanhMucSanPham[] $sanphams
 * @var \common\models\PhanLoai $phan_loai_san_pham
 ...
 */
$this->title = $phan_loai_san_pham->name;
?>
        ...
        <div class="container">
            <div class="pager-sec">
                <div class="page-title">
                    <h3><?=$phan_loai_san_pham->name?></h3>
                </div>
                <!--page-title end-->
                <div class="page-links">
                    <ul>
                        <li><a href="<?=\yii\helpers\Url::toRoute('site/index') ?>" title="">Home</a></li>
                        <li><a href="<?=\yii\helpers\Url::toRoute(['site/san-pham','path'=>$phan_loai_san_pham->code]) ?>" title=""><?=$phan_loai_san_pham->name?></a></li>
                    </ul>
                </div>
                <!--page-links end-->
            </div>
                        ...
                        <div class="widget widget-categories wow fadeInLeft animated" data-wow-delay="500ms" data-wow-duration="1500ms">
                            ...
                            <ul>
                                <?php foreach ($sanphams_banchay as $san_pham): ?>
                                    <li>
                                        <?=\yii\bootstrap\Html::a($san_pham->name,\yii\helpers\Url::toRoute(['site/product','path'=>$san_pham->code])) ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                                    ...
                                    <div class="portfolio-item wow fadeInLeft animated" data-wow-delay="500ms" data-wow-duration="1500ms">
                                        <div class="item-img">
                                            ...
                                            <div class="add-to-cart">
                                                <a class="" href="<?=\yii\helpers\Url::toRoute(['site/product','path'=>$sanpham->code])?>" title="" data-value="<?=$sanpham->code.'-'.$san_pham->id?>">
