...
/**
 * @var \common\models\ChiTietSanPham[] $sanPhams_ThuongHieu
        ...
        <div class="container">
            <div class="pager-sec">
                <div class="page-title">
                    <h3><?=$ThuongHieu->name?></h3>
                </div>
                <!--page-title end-->
                <div class="page-links">
                    <ul>
                        <li><a href="<?=\yii\helpers\Url::toRoute('site/index') ?>" title="">Home</a></li>
                        <li><a href="<?=\yii\helpers\Url::toRoute(['site/thuong-hieu','path'=>$ThuongHieu->code]) ?>" title=""><?=$ThuongHieu->name?></a></li>
                    </ul>
                </div>
                <!--page-links end-->
            </div>
                ...
                <div class="col-lg-9">
                    <div class="main-items-sec">
                        <div class="items-show-sec current" id="tab-v1">
                            <div class="row">
                                <?php foreach ($sanPhams_ThuongHieu as $sanpham): ?>
